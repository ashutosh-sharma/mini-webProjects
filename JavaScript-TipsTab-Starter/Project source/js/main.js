...
function generateNumber(){
	var randomTipNo = Math.floor((Math.random() * 11) + 1);
	return randomTipNo;
}
...
function generateTip(){
	...
	var sel = document.querySelector('.js-tip');
...
//calling onTipButtonClick() so that whenever button will be clicked the actions will be performed!
onTipButtonClick();
